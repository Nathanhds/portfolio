        ...
        <section className="experience" id="experience">
            ...
            <div className="cards">
                <div className="card">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="53.3" height="53.3" backfill="currentColor" class="bi bi-code-slash" viewBox="0 0 16 16">
                ...
                <div className="card">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="53.3" height="53.3" fill="currentColor" class="bi bi-laptop" viewBox="0 0 16 16">
                ...
                <div className="card">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="53.3" height="53.3" fill="currentColor" class="bi bi-trello" viewBox="0 0 16 16">
